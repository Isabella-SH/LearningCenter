...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public Page<Student> getAll(Pageable pageable) { //parametro de paginacion
    ...
    public Student create(Student student) {
        ...
        if(studentWithName !=null){
            throw  new ResourceValidationException(ENTITY, "An student with tne same name alredy exists");
        }
    ...
    public Student update(Long studentId, Student student) {
        ...
        //Perform creation operation
        return studentRepository.findById(studentId).map(studentToUpdate -> studentRepository.save(
